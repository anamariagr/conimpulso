...
export default function AdvisorDashboardPage() {
  ...
  const getLevelBadge = (level) => {
    const badges = {
      ...
      gold: 'bg-accent-500 text-accent-900',
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white pt-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-[#4d3cbb]">Panel de Asesor</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-[#1A1A1A] rounded-xl p-6 border border-gray-800">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs text-accent-500 bg-accent-900/30 px-2 py-1 rounded">Pendiente</span>
            </div>
            <p className="text-gray-400 text-sm mb-1">Comisión Pendiente</p>
            <p className="text-2xl font-bold text-[#4d3cbb]">${stats.pending?.toLocaleString() || 0}</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <Link
            ...
            className="bg-[#1A1A1A] rounded-xl p-6 border border-gray-800 hover:border-[#4d3cbb] transition group"
          >
            <div className="flex items-center justify-between">
              <div>
                <div className="w-12 h-12 bg-[#4d3cbb]/10 rounded-xl flex items-center justify-center mb-4">
                  <Plus className="w-6 h-6 text-[#4d3cbb]" />
                </div>
              ...
              <ChevronRight className="w-5 h-5 text-gray-600 group-hover:text-[#4d3cbb] transition" />
            </div>
          </Link>
        ...
        {/* No Profile Banner */}
        {!profile && (
          <div className="bg-gradient-to-r from-[#4d3cbb]/20 to-transparent border border-[#4d3cbb]/30 rounded-xl p-8 mb-8">
            <div className="flex items-center gap-4 mb-4">
              <Award className="w-12 h-12 text-[#4d3cbb]" />
              <div>
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#4d3cbb] text-black font-semibold rounded-lg hover:bg-accent-400 transition"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          >
            <Users className="w-8 h-8 text-[#4d3cbb] mx-auto mb-2" />
