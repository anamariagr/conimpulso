...
const modules = [
  ...
  { name: 'B2B', icon: Zap, endpoints: 15, color: 'text-accent-500' },
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white pt-20 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center gap-3 mb-8">
          <Book className="w-8 h-8 text-[#4d3cbb]" />
          <h1 className="text-3xl font-bold text-[#4d3cbb]">API Documentation</h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {modules.map((module) => (
            <div key={module.name} className="bg-[#1A1A1A] rounded-xl p-4 border border-gray-800 hover:border-[#4d3cbb] transition cursor-pointer">
        ...
        <div className="bg-[#1A1A1A] rounded-xl p-6 border border-gray-800 mb-8">
          ...
          <a
            ...
            download
            className="inline-flex items-center gap-2 px-4 py-2 bg-[#4d3cbb] text-black font-medium rounded-lg hover:bg-accent-400 transition"
          >
        ...
        <div className="bg-[#1A1A1A] rounded-xl p-6 border border-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-[#0A0A0A] rounded-lg p-4 text-center">
              <p className="text-2xl font-bold text-[#4d3cbb]">60</p>
